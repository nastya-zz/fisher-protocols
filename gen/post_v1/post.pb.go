...
var file_post_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x41, 0x74, 0x22, 0xb0, 0x01, 0x0a, 0x05, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x12, 0x26,
	...
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x83, 0x01, 0x0a, 0x04, 0x4c, 0x69, 0x6b, 0x65,
...
var file_post_proto_depIdxs = []int32{
	...
	21, // 6: post_v1.Post.created_at:type_name -> google.protobuf.Timestamp
	21, // 7: post_v1.Post.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 8: post_v1.Media.type:type_name -> post_v1.MediaType
	21, // 9: post_v1.Like.created_at:type_name -> google.protobuf.Timestamp
	21, // 10: post_v1.Comment.created_at:type_name -> google.protobuf.Timestamp
	21, // 11: post_v1.Comment.updated_at:type_name -> google.protobuf.Timestamp
	...
	10, // 15: post_v1.PostService.CreatePost:input_type -> post_v1.CreatePostRequest
	9,  // 16: post_v1.PostService.UploadMedia:input_type -> post_v1.UploadMediaResponse
	11, // 17: post_v1.PostService.GetPost:input_type -> post_v1.GetPostRequest
	12, // 18: post_v1.PostService.UpdatePost:input_type -> post_v1.UpdatePostRequest
	13, // 19: post_v1.PostService.DeletePost:input_type -> post_v1.DeletePostRequest
	15, // 20: post_v1.PostService.AddLike:input_type -> post_v1.AddLikeRequest
	16, // 21: post_v1.PostService.AddComment:input_type -> post_v1.AddCommentRequest
	17, // 22: post_v1.PostService.RemoveLike:input_type -> post_v1.RemoveLikeRequest
	19, // 23: post_v1.PostService.RemoveComment:input_type -> post_v1.RemoveCommentRequest
	2,  // 24: post_v1.PostService.CreatePost:output_type -> post_v1.Post
	9,  // 25: post_v1.PostService.UploadMedia:output_type -> post_v1.UploadMediaResponse
	2,  // 26: post_v1.PostService.GetPost:output_type -> post_v1.Post
	2,  // 27: post_v1.PostService.UpdatePost:output_type -> post_v1.Post
	14, // 28: post_v1.PostService.DeletePost:output_type -> post_v1.DeletePostResponse
	4,  // 29: post_v1.PostService.AddLike:output_type -> post_v1.Like
	5,  // 30: post_v1.PostService.AddComment:output_type -> post_v1.Comment
	18, // 31: post_v1.PostService.RemoveLike:output_type -> post_v1.RemoveLikeResponse
	20, // 32: post_v1.PostService.RemoveComment:output_type -> post_v1.RemoveCommentResponse
